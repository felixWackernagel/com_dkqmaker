 ...
 * Quiz Model
 */
class DKQMakerModelQuizzer extends JModelAdmin
{
        /**
         ...
         * @since       2.5
         */
        public function getTable($name = 'Quizzer', $prefix = 'DKQMakerTable', $options = array())
        {
        ...
        {
                // Get the form.
                $form = $this->loadForm('com_dkqmaker.quizzer', 'quizzer',
